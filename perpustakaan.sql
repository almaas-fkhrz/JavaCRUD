...
--
-- Host: localhost
-- Generation Time: Mar 07, 2021 at 10:58 AM
...
(1, '2A', 'Maas', 'L', 'IT', '0831', 'Purbalingga'),
(2, '2B', 'Deva', 'L', 'AP', '0821', 'Purbalingga');
...
(1, '5AA3', 'Matem', 'Maas', 'Gramed', '2020', 10);
...
--
ALTER TABLE `buku`
  ADD PRIMARY KEY (`id_buku`,`kode_buku`) USING BTREE;
...
ALTER TABLE `pengembalian`
  ...
  ADD KEY `FK_IdBukuPengembalian` (`id_buku`),
  ADD KEY `FK_IdPetugasPengembalian` (`id_petugas`);
...
--
ALTER TABLE `pengembalian`
  ADD CONSTRAINT `FK_IdBukuPengembalian` FOREIGN KEY (`id_buku`) REFERENCES `buku` (`id_buku`),
  ADD CONSTRAINT `FK_IdPetugasPengembalian` FOREIGN KEY (`id_petugas`) REFERENCES `petugas` (`id_petugas`);

--
-- Constraints for table `rak`
--
ALTER TABLE `rak`
  ADD CONSTRAINT `FK_IdBukuRak` FOREIGN KEY (`id_buku`) REFERENCES `buku` (`id_buku`);
COMMIT;
